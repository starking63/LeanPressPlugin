    ...
    <div class="themes wp-clearfix">
		...
		<?php if ( $certificates ) { ?>
			...
			<?php foreach ( $certificates as $id ) {
                ...
                $thumbnail = $cert_image ? $certificate->get_cert_thumbnail(): $certificate->get_template();
				?>
                    ...
                    <div class="theme-screenshot">
                        <div id="<?php echo $template_id; ?>" class="certificate-preview">
                            <div class="certificate-preview-inner">
                                <img class="cert-template" src="<?php echo $thumbnail; ?>">
                            </div>
                        </div>
                    </div>
                    <?php if(!$cert_image): ?>
                        <script type="text/javascript">
                            ...
                            $('.course-certificates').click(function ($) {
                                window.certificates = window.certificates || [];
                                window.certificates.push(new LP_Certificate('#<?php echo $template_id;?>', <?php echo $certificate_data;?>));
                            })
